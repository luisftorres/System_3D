...
import numpy as np
bus = smbus.SMBus(3)
address = 0x5e         # esta direccion de sensor se otorga despues del hard reset
adrress_set = 0x4a     # esta direccion de sensor se fija en la configuracion 
LPM = 0x05 
FPM = 0x06
MCM = 0xff            # Master Controled Mode
t_wait = 0.0005;
mode_sensor = MCM
cols = 7
fils = 10000
