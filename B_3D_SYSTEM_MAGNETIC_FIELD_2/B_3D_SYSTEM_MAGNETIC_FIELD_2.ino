...
long int Dx,Dy,Dz;
int       R_factor;
long int resolution_x = 16;                    // 160 steps by 1mm
long int resolution_yz = 80;                  // 801 steps by 1mm
 ...
 Serial.begin(115200);
  ...
  digitalWrite(END,LOW);
   ...
   digitalWrite(Z_ENABLE_PIN,HIGH);
    ...
    resolution_x = resolution_x*R_factor;                    // 160 steps by 1mm
    resolution_yz = resolution_yz*R_factor; 
